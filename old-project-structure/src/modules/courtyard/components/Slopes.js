...
export default function Slopes() {
  const { scene } = useGLTF("/models/examples/slopes.glb");
  ...
  const clonedScene = useMemo(() => {
    ...
    const staticMaterial = new THREE.MeshStandardMaterial({ color: "#6f6f6f" });
...
useGLTF.preload("/models/examples/slopes.glb");
